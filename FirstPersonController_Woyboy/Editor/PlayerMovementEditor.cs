...
namespace FirstPersonController_Woyboy
{
    ...
    public class PlayerMovementEditor : Editor
    {
        ...
        private SerializedProperty playerCanJumpProp;
        ...
        private void OnEnable()
        {
            ...
            playerCanJumpProp = serializedObject.FindProperty("playerCanJump");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(playerCanJumpProp);
